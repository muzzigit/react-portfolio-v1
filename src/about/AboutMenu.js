...
export default class AboutMenu extends Component {
  constructor(props) {
    super(props);
    this.state = {
      activeMenuItem: 1, // Default to "About Me" tab
      activeSubheading: 1,
    };
  }
  ...
  handleMenuItemClick = (menuItem) => {
    this.setState({
      ...
      activeSubheading: 1, // Reset to the first subheading when a new menu item is clicked
    });
  };
  ...
  render() {
    ...
    const menuItems = ["PERSONAL", "EDUCATION", "CAREER"]; // "Photography" is now part of "Personal"
    ...
    // Combine the subheadings for "About Me" and "Automotive Photography" if activeMenuItem is 1
    const subheadings =
      activeMenuItem === 1
        ? [...subheadingsData[1]]
